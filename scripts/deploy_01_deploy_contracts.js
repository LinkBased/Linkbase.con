...
async function main() {
    ...
    // await (await lbdToken.whitelistAddressFromTransferFees("SOME_ADDRESS")).wait()
    // console.log('LbdToken.whitelistAddressFromTransferFees(',"SOME_ADDRESS",') succeeded')

    await (await lbdToken.setBigTransferFeeWalletReceiver(contracts.BigTransferFeeWalletReceiver)).wait()
    console.log('LbdToken.setBigTransferFeeWalletReceiver(', contracts.BigTransferFeeWalletReceiver, ') succeeded')

    await (await lbdToken.setSmallTransferFeeWalletReceiver(contracts.SmallTransferFeeWalletReceiver)).wait()
    console.log('LbdToken.setSmallTransferFeeWalletReceiver(', contracts.SmallTransferFeeWalletReceiver, ') succeeded')
